...
export default function AIChat({ code, language, problemTitle, theme = 'vs-dark' }: AIChatProps) {
  ...
  return (
    <div className={`flex flex-col h-full max-h-full overflow-hidden ${theme === 'vs-dark' ? 'bg-gray-900 border-l border-gray-700' : 'bg-white border-l border-gray-200'}`}>
      ...
      {/* Input - Fixed Height with AI Icon and Label */}
        ...
        <div className="flex space-x-2">
          <div className="flex items-start space-x-2 flex-1">
            <div className={`flex items-center justify-center w-8 h-8 rounded-full mt-1 ${
              theme === 'vs-dark' ? 'bg-blue-600' : 'bg-blue-600'
            }`}>
            ...
            <div className="flex-1">
              ...
              <textarea
                ...
                className={`w-full p-2 text-xs rounded-md resize-none focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-colors ${
                  theme === 'vs-dark'
